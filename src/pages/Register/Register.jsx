...
import RegisterLottieData from'../../assets/lottiee/register.json'
...
const Register = () => {
    ...
    const handleRegister = e =>{
        ...
        password.validation
        const isValidPassword = /^(?=.*[A-Z])(?=.*\d)[A-Za-z\d]{6,}$/.test(password);
        if (!isValidPassword) {
            return alert("❌ Password must be at least 6 characters, include one uppercase letter and one number.");
          }
